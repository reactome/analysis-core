...
public class ParserProteoformNeo4j extends Parser {
    ...
    public static final String PROTEOFORM_NEO4J = "([OPQ][0-9][A-Z0-9]{3}[0-9]|[A-NR-Z][0-9]([A-Z][A-Z0-9]{2}[0-9]){1,2})([-]\\d{1,2})?,(-?\\d+|[Nn][Uu][Ll][Ll])?,(-?\\d+|[Nn][Uu][Ll][Ll])?,\\\"?\\[(\\\"\\\"\\d{5}:(\\d{1,11}|[Nn][Uu][Ll][Ll])\\\"\\\"(,\\\"\\\"\\d{5}:(\\d{1,11}|[Nn][Uu][Ll][Ll])\\\"\\\")*)?\\]\\\"?";
